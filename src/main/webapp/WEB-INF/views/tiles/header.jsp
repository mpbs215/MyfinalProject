...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/boardTable.css">
		...
		<div class="container">
			...
			<nav id="nav-menu-container">
				<ul class="nav-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/common/introduce">서비스
							안내</a></li>
					<li><a
					...
					<li><a
						href="${pageContext.request.contextPath}/sign/signUpForm">회원
							가입</a></li>
