...
<script type="text/javascript">
	...
	$('button[name="cancelReserve"]').click(function(){		
	...
	<div class="container-fluid">
		...
		<ul id="myTab" class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active"><a
				...
				data-toggle="tab" aria-controls="home" aria-expanded="true">현재 예약 현황</a></li>
							...
							<c:otherwise>
								<c:forEach items="${requestScope.reserveListLoad}" var="reserveListLoad">
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-link btn" name="cancelReserve" value="${reserveListLoad.reserveNo}">
