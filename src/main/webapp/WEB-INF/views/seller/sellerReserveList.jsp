                        ...
                        <c:choose>
                           ...
                           <c:otherwise>
                              <c:forEach items="${requestScope.reserveListLoad}"
                                 ...
                                 <tr>
                                    <td><a
                                       href="${pageContext.request.contextPath}/user/userReserveForm?parkNo=${reserveListLoad.parkDto.parkNo}">${reserveListLoad.parkDto.parkName}</a></td>
                        ...
                        <c:choose>
                           ...
                           <c:otherwise>
                              <c:forEach items="${requestScope.reserveList}"
                                 ...
                                 <tr>
                                    <td><a
                                       href="${pageContext.request.contextPath}/user/userReserveForm?parkNo=${reserveListLoad.parkDto.parkNo}">${reserveList.parkDto.parkName}</a></td>
